...
const PRO_MONTHLY_PRICE_LABEL = "$7.99/month";
...
export async function getBillingAccessDecisionForUser(
  ...
  return {
    allowed: false,
    reason: "Your free plan includes one connected app. Upgrade to ClawLink Pro for $7.99/month to add more integrations.",
  };
}
