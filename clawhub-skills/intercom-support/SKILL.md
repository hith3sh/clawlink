...
Powered by [ClawLink](https://claw-link.dev), an integration hub for OpenClaw that handles hosted connection flows and credentials so you don't need to configure Intercom API access yourself.
...
6. Tell the user to connect Intercom at [claw-link.dev/dashboard?add=intercom](https://claw-link.dev/dashboard?add=intercom)
