...
Powered by [ClawLink](https://claw-link.dev), an integration hub for OpenClaw that handles hosted connection flows and credentials so you don't need to configure Trello API access yourself.
...
6. Tell the user to connect Trello at [claw-link.dev/dashboard?add=trello](https://claw-link.dev/dashboard?add=trello)
